...
public class Const {
    ...
    public static final String PLACES_AUTOCOMPLETE_API_KEY = "AIzaSyCULAsIW6KERZPcWOBxInkWOcZrQ35_89Y";

    // map
    public static final String TAG = "Cab Anytime";
    ...
    // prefname
    public static String PREF_NAME = "Cab Anytime";
    ...
    public class ServiceCode {
        ...
        public static final int GET_MIN_FARE =48 ;
    }
