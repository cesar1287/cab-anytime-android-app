...
import com.virtugos.uberapp.adapter.DrawerAdapter;
import com.virtugos.uberapp.component.MyFontTextView;
import com.virtugos.uberapp.db.DBHelper;
import com.virtugos.uberapp.fragments.FeedbackFragment;
import com.virtugos.uberapp.fragments.MapFragment;
import com.virtugos.uberapp.fragments.MyBookingsFragment;
import com.virtugos.uberapp.fragments.TripFragment;
import com.virtugos.uberapp.models.ApplicationPages;
import com.virtugos.uberapp.models.Booking;
import com.virtugos.uberapp.models.Card;
import com.virtugos.uberapp.models.Driver;
import com.virtugos.uberapp.models.Reffral;
import com.virtugos.uberapp.models.User;
...
public class MainDrawerActivity extends ActionBarBaseActivitiy implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mint.initAndStartSession(this, "5da89c87");
        ...
        /*if (!Const.isShowNoteDialog) {
            Const.isShowNoteDialog = true;
...
//                        }
                ...
                if (pContent.isSuccess(response)) {
                    ...
                    switch (pContent.checkRequestStatus(response)) {
                        ...
                        case Const.IS_WALKER_STARTED:
                            Log.d("GET_REQUEST_STATUS", "************MAINDRAWER************" + "IS_WALKER_STARTED");
                            Driver driver = pContent.getDriverDetail(response);
                            gotoTripFragment(driver);
                            break;

                        case Const.IS_WALKER_RATED:
                            Log.d("GET_REQUEST_STATUS", "************MAINDRAWER************" + "IS_WALKER_RATED");
    ...
    protected void onDestroy() {
        ...
        if (Const.isShowNoteDialog)
            AndyUtils.dissmissNoteDialog(this);
    ...
    public void onDrawerSlide(View view, float arg1) {
        ...
        if(display.getHeight()>getTotalHeightofListView(listDrawer)){
            footerView = getLayoutInflater().inflate(R.layout.menu_footer, null);

            tvfooter = (TextView) footerView.findViewById(R.id.tvfooter);
            ViewGroup.LayoutParams params = tvfooter.getLayoutParams();
            params.height =display.getHeight()-(getTotalHeightofListView(listDrawer));

            if(params.height>0){
                listDrawer.addFooterView(footerView);
...
//        listView.requestLayout();
    ...
    private void requestRequiredPermission() {
        Log.d("isNetworkAvailable", "********************requestRequiredPermission***********");
...
//        }
    ...
    public void callToDriver(String number) {
        driverNumber = number;
        if (ContextCompat.checkSelfPermission(this, android.Manifest.permission.CALL_PHONE) != android.content.pm.PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(this, new String[]{android.Manifest.permission.CALL_PHONE, android.Manifest.permission.CALL_PHONE}, Const.PERMISSION_CALL);
        } else {
