 ...
 * 
 */
package com.virtugos.uberapp.event;
...
import com.virtugos.uberapp.ActionBarBaseActivitiy;
	...
	public void onClick(View v) {
		...
		case R.id.confirm_schedule:
			if (isDateSelected) {
				...
				btnSetDate.setText(AddEventActivity.this.getResources().getText(R.string.text_select_time));
				return;
			}
