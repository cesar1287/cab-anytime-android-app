...
import com.virtugos.uberapp.parse.MultiPartRequester;
...
public class RegisterFragment extends BaseFragmentRegister
    ...
    public void onCreate(Bundle savedInstanceState) {
       ...
       activity.setIconMenu(R.drawable.close_payment);
        ...
        facebookConfiguration = new SimpleFacebookConfiguration.Builder()
                .setAppId(activity.getResources().getString(R.string.applicationId))
                .setNamespace(activity.getResources().getString(R.string.app_name))
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        activity.setTitle(activity.getResources().getString(R.string.text_register));
//        activity.setIconMenu(R.drawable.close_payment);
//        activity.btnActionMenu.setOnClickListener(this);
//        activity.btnNotification.setVisibility(View.VISIBLE);
        ...
        ivPassword = (View) view.findViewById(R.id.ivPassword);
