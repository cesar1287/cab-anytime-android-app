...
public class BookingAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if ((booking.getTag()).equalsIgnoreCase("ongoing")) {
			...
			holder.tripStatus.setBackgroundResource(R.drawable.box_ongoing_design);
			...
			holder.ivSource.setBackgroundResource(R.drawable.ellipse_theame);
		...
		if (booking.getTag().equalsIgnoreCase("future")) {
			...
			holder.tripStatus.setBackgroundResource(R.drawable.box_future_design);
			...
			holder.ivSource.setBackgroundResource(R.drawable.ellipse_black);
			holder.tvSource.setText(booking.getSource());
			holder.tvSource.setSingleLine();
		}
